...
ALTER TABLE endpoints ADD COLUMN capability_score REAL NOT NULL DEFAULT 0.5;
...
ALTER TABLE api_keys ADD COLUMN daily_spend_limit REAL;
ALTER TABLE projects ADD COLUMN daily_spend_limit REAL;

-- Usage: estimated spend + routing / context observability
ALTER TABLE usage_logs ADD COLUMN estimated_cost REAL NOT NULL DEFAULT 0;
