...
- **[design/freetoken_analysis.md](./design/freetoken_analysis.md)**: Analysis of the FreeToken paper (semantic incremental checkpoints) and takeaways for cache-aware routing and trim stability.
