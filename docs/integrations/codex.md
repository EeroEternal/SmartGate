...
4. Use the SmartGate API base URL for your deployment. The examples below use `https://api.smartgate.run/v1`; replace it with your own URL when self-hosting.
...
name = "SmartGate"
base_url = "https://api.smartgate.run/v1"
