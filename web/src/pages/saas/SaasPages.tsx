...
import { AlertCircle, CheckCircle2, ChevronDown, ChevronRight, Copy, Eye, EyeOff, LogOut, Plus, Settings2, Trash2, UserCircle, X } from 'lucide-react'
...
type ServiceEndpoint = { id: string; provider_name: string; provider_type: string; model: string; base_url: string; input_price_per_1m: number; output_price_per_1m: number; capability_score: number; context_length?: number }
