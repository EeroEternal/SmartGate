...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-zinc-50 text-zinc-950">
      ...
      <main>
        <section className="max-w-6xl mx-auto px-6 pt-20 pb-24 grid lg:grid-cols-[1.15fr_.85fr] gap-16 items-center">
          <div>
            ...
            <p className="mt-7 max-w-xl text-lg leading-8 text-zinc-600">SmartGate gives you one simple API for your AI model services, routing each request by cost, capability, and health so you do not overpay.</p>
          ...
          <div className="rounded-3xl sg-dark-surface p-5 shadow-2xl shadow-zinc-300/50 rotate-1">
            <div className="rounded-2xl bg-zinc-900 border border-zinc-800 p-5 text-white">
              ...
              <div className="mt-8 rounded-xl bg-zinc-800 p-4"><div className="flex items-center justify-between text-xs"><span className="sg-dark-muted">Without cost routing</span><span className="font-mono text-zinc-300">$4.01</span></div><div className="mt-3 h-2 rounded-full bg-zinc-700"><div className="h-full w-full rounded-full bg-zinc-500" /></div><div className="mt-4 flex items-center justify-between text-xs"><span className="text-white">With SmartGate routing</span><span className="font-mono text-emerald-400">$2.84</span></div><div className="mt-3 h-2 rounded-full bg-zinc-700"><div className="h-full w-[71%] rounded-full bg-emerald-400" /></div></div>
        ...
        <section className="bg-zinc-950 text-white"><div className="max-w-6xl mx-auto px-6 py-20 grid lg:grid-cols-[.9fr_1.1fr] gap-12 items-center"><div><div className="flex items-center gap-2 text-sm text-zinc-300"><ShieldCheck className="w-4 h-4" /> Built for Codex</div><h2 className="mt-5 text-3xl font-semibold tracking-tight">Bring Codex into your model stack.</h2><p className="mt-4 max-w-xl text-sm leading-7 text-white/90">Use SmartGate with Codex through the OpenAI Responses API. Keep the Codex experience you know while SmartGate handles model choice, provider fallback, budgets, and usage visibility behind the scenes.</p><div className="mt-7 flex flex-wrap gap-3 text-sm"><span className="rounded-full border border-white/20 px-3 py-1.5 text-white/90">Codex GUI support</span><span className="rounded-full border border-white/20 px-3 py-1.5 text-white/90">Smart model routing</span><span className="rounded-full border border-white/20 px-3 py-1.5 text-white/90">Usage and budget controls</span></div></div><div className="rounded-2xl border border-zinc-800 bg-zinc-900 p-6 shadow-xl"><div className="flex items-center justify-between border-b border-zinc-800 pb-5"><div><div className="text-xs uppercase tracking-[0.18em] text-zinc-400">Your coding workflow</div><div className="mt-2 text-xl font-semibold text-white">Codex <span className="text-zinc-500">×</span> SmartGate</div></div><div className="rounded-xl bg-emerald-400/10 px-3 py-2 text-xs font-medium text-emerald-400">Connected</div></div><div className="mt-6 space-y-3"><div className="flex items-center justify-between rounded-xl bg-zinc-800 px-4 py-3"><span className="text-sm text-white">Codex requests</span><span className="text-xs text-zinc-400">One gateway</span></div><div className="flex items-center justify-between rounded-xl bg-zinc-800 px-4 py-3"><span className="text-sm text-white">Model providers</span><span className="text-xs text-zinc-400">Smart fallback</span></div><div className="flex items-center justify-between rounded-xl bg-zinc-800 px-4 py-3"><span className="text-sm text-white">Spend visibility</span><span className="text-xs text-zinc-400">Always on</span></div></div></div></div></section>
      ...
      <footer className="max-w-6xl mx-auto px-6 py-8 text-xs text-zinc-500 flex justify-between"><span>© SmartGate</span><span>Spend less. Stay in control of every token.</span></footer>
    </div>
  )
}
